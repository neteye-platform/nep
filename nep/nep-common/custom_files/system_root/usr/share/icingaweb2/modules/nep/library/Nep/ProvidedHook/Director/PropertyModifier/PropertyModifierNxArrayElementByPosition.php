...
class PropertyModifierNxArrayElementByPosition extends PropertyModifierHook
{
    public function getName()
    {
        return '[NX] Get a specific Array Element';
    }
    ...
    public static function addSettingsFormFields(QuickForm $form)
    {
        ...
        $form->addElement('text', 'position', [
            ...
            'description' => $form->translate(
                'Numeric position or key name (references to other columns are accepted)'
            ),
        ]);
    ...
    public function transform($value)
    {
        ...
        switch ($this->getSetting('position_type')) {
            ...
            case 'fixed':
                ...
                $pos = SyncUtils::fillVariables($this->getSetting('position'), $this->getRow());
                $pos = (int) $pos;

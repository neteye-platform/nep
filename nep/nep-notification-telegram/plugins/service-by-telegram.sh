...
The following are mandatory:
  ...
  -j TELEGRAM_THREADID (\$telegram_threadid$)
...
while getopts 4:6:b:c:d:e:f:h:i:l:n:o:p:j:q:r:s:t:u:v:D opt
do
  case "$opt" in
...
/usr/bin/curl $CURLARGS \
    --data-urlencode "message_thread_id=${TELEGRAM_THREADID}" \
